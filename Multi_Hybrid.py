...
def build_model(X, y):
    ...
    # lstm3_1 = LSTM(30, return_sequences=True)(flat3)
    ...
    # plot_model(model, show_shapes=True, to_file='DP13_pics/DP13_Multi_hybrid.png')
...
subsequences, n_steps = 10, 20 # 8, 25
...
# model.save('DP13_models/DP13_Multi_hybrid.h5')
...
cm_analysis(testy, pred_y, filename='DP13_pics/DP13_Multi_hybrid_CM.png',
